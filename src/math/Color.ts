export class Color extends Float32Array {
    ...
    public set r(value: number) { this[0] = value; }
    public get g(): number { return this[1]; }
    public set g(value: number) { this[1] = value; }
    public get b(): number { return this[2]; }
    public set b(value: number) { this[2] = value; }
    public get a(): number { return this[3]; }
    public set a(value: number) { this[3] = value; }
